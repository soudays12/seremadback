...
<body class="bg-gray-100 p-6 font-sans">
    ...
    <div class="max-w-xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div class="p-6 space-y-4">
            ...
            <div>
                <p class="text-gray-700"><span class="font-semibold">Ville :</span> {{ $ville }}</p>
            </div>
            <div>
                <p class="text-gray-700"><span class="font-semibold">Code postal :</span> {{ $postal }}</p>
            </div>
            <div>
                <p class="text-gray-700"><span class="font-semibold">Option :</span> {{ $option }}</p>
            </div>
            <div>
