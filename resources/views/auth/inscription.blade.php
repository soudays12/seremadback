...
<body class="min-h-screen bg-gray-50 flex items-center justify-center p-6">
  ...
  <main class="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
    ...
    <form id="loginForm" action="{{ route('auth.register') }}" method="POST" class="space-y-5" novalidate>
        @csrf
    ...
    <p class="mt-6 text-center text-sm text-gray-600">
      ...
      <a href="{{ route('auth.login') }}" class="text-indigo-600 hover:underline">se connecter</a>
    </p>
  </main>
